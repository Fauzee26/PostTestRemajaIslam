//
//  RemajaTableViewController.swift
//  PostTestRemajaIslam
//
...
import UIKit
var TITle = ["Masih Malas Bangun Subuh","Yang Jarang Diketahui dari Puasa Asyura","Doa pada Orang Tua Kita Bagaimana?","Menikah itu Pembuka Pintu Rezeki, Tak Percaya?","Di Masjid Hatiku Terkait"]
...
var myIndex = 0
class RemajaTableViewController: UITableViewController {
    ...
    let gambarBerita : [String] = ["Masih Malas Bangun Subuh.jpg", "Yang Jarang Diketahui dari Puasa Asyura.jpg", "Doa pada Orang Tua Kita Bagaimana?.jpg", "Menikah itu Pembuka Pintu Rezeki, Tak Percaya?.jpg", "Di Masjid Hatiku Terkait.jpg"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.labelJudul.text = TITle[indexPath.row]
